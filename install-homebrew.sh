...
[ -d ${HOMEBREW_PREFIX}/Homebrew/Library/Taps/homebrew/homebrew-core ] || {
    ...
    curl -sL https://github.com/digitalspacestdio/homebrew-core/compare/master...aarch64.diff | patch -p1 || true;
}
